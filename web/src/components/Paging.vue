  ...
  <div class="px-[15px] flex justify-between border-t-[1px] border-gray-400">
    <div class="">
      ...
      <div class="flex">
        ...
        <button :disabled="modelValue.page == modelValue.total_pages || !modelValue.total_pages" class="border-blue-600 p-2 py-1 border-[1px] rounded mx-1 hover:bg-blue-600 hover:text-white" @click="() => (modelValue.page = modelValue.total_pages > modelValue.page ? modelValue.page + 1: modelValue.total_pages)">&gt;</button>
        <button :disabled="modelValue.page == modelValue.total_pages || !modelValue.total_pages" class="border-blue-600 p-2 py-1 border-[1px] rounded mx-1 hover:bg-blue-600 hover:text-white" @click="() => (modelValue.page = modelValue.total_pages)">&gt;&gt;</button>
      </div>
    </div>
